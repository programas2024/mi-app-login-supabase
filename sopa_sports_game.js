// sopa_sports_game.js - Lógica para el juego de Sopa de Letras (Tema Deportes)
...
// Palabras principales a encontrar (15 palabras) para DEPORTES
const MAIN_WORDS = [
    "FUTBOL", "BALONCESTO", "TENIS", "NATACION", "CICLISMO",
    "VOLEIBOL", "BOXEO", "GOLF", "ATLETISMO", "GIMNASIA",
    "ESGRIMA", "RUGBY", "BEISBOL", "HOCKEY", "KARATE"
];

// Palabras sorpresa (no visibles en la lista, pero dan puntos extra) para DEPORTES
const SURPRISE_WORDS = [
    "SURF", "YOGA", "AJEDREZ", "ESCALADA", "REMO",
    "ARQUERIA", "BOLOS", "CRICKET", "DARDOS", "PARACAIDISMO"
];

const ALL_WORDS = [...MAIN_WORDS, ...SURPRISE_WORDS];

let gameGrid = [];
let placedWords = []; // { word: "FUTBOL", cells: [{row:0, col:0}, ...], isFound: false, isBonus: false }
