    ...
    try {
        ...
        const profileHtml = `
            <div class="friend-profile-card">
                ...
                <p><strong>Perlas:</strong> ${friendProfile.perla || 0} ⚪</p>

                
              <button id="message-friend-btn" class="swal-custom-btn swal-btn-message" title="Enviar un mensaje a este amigo">
