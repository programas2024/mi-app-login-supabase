// sopa_animals_game.js - Lógica para el juego de Sopa de Letras (Tema Animales)
...
// Palabras principales a encontrar (15 palabras)
const MAIN_WORDS = [
    "LEON", "TIGRE", "ELEFANTE", "JIRAFA", "MONO",
    "CEBRA", "DELFIN", "BALLENA", "TORTUGA", "SERPIENTE",
    "OSO", "LOBO", "ZORRO", "CONEJO", "PATO"
];

// Palabras sorpresa (no visibles en la lista, pero dan puntos extra)
const SURPRISE_WORDS = [
    "PANDA", "KOALA", "PINGUINO", "CANGURO", "GUEPARDO",
    "BUHO", "AGUILA", "FLAMENCO", "COLIBRI", "COCODRILO"
];

const ALL_WORDS = [...MAIN_WORDS, ...SURPRISE_WORDS];

let gameGrid = [];
let placedWords = []; // { word: "LEON", cells: [{row:0, col:0}, ...], isFound: false, isBonus: false }
